...
from consent import ask_user_for_tool_call_consent
...
class MCPClient:
    ...
    async def process_query(self, query: str) -> str:
        ...
        try:
            ...
            print("Sending data to Groq API",groq_tools,messages)
            ...
            print("Response from Groq API",response_data)
            ...
            if not tool_calls:
                ...
                return "\n".join(final_text)
            approved = ask_user_for_tool_call_consent(response_data)

            if not approved:
                return "User did not approve the tool call"
